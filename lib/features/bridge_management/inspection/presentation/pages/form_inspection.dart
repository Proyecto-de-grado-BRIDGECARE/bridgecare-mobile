...
import 'package:bridgecare/features/bridge_management/inspection/presentation/widgets/build_form.dart';
...
class _FormInspectionState extends State<FormInspection> {
  ...
  final TextEditingController inspeccionEspecialJuntas =
  ...
  final TextEditingController cantidadReparacionJuntas =
      TextEditingController();
  ...
  final TextEditingController inspeccionEspecialAndenes =
      TextEditingController();
  ...
  final TextEditingController cantidadReparacionAndenes =
      TextEditingController();
  ...
  final TextEditingController inspeccionEspecialBarandas =
      TextEditingController();
  ...
  final TextEditingController cantidadReparacionBarandas =
      TextEditingController();
  ...
  final TextEditingController inspeccionEspecialAletas =
      TextEditingController();
  ...
  final TextEditingController cantidadReparacionAletas =
      TextEditingController();
  ...
  final TextEditingController inspeccionEspecialEstribos =
      TextEditingController();
  ...
  final TextEditingController cantidadReparacionEstribos =
      TextEditingController();
  ...
  final TextEditingController inspeccionEspecialApoyos =
      TextEditingController();
  ...
  final TextEditingController cantidadReparacionApoyos =
      TextEditingController();
  ...
  final TextEditingController calificacionVigasLarguerosDiafragmas =
      TextEditingController();
  final TextEditingController mantenimientoVigasLarguerosDiafragmas =
      TextEditingController();
  final TextEditingController inspeccionEspecialVigasLarguerosDiafragmas =
      TextEditingController();
  final TextEditingController numeroFotosVigasLarguerosDiafragmas =
      TextEditingController();
  final TextEditingController tipoDanoVigasLarguerosDiafragmas =
      TextEditingController();

  final TextEditingController tipoReparacionVigasLarguerosDiafragmas =
      TextEditingController();
  final TextEditingController cantidadReparacionVigasLarguerosDiafragmas =
      TextEditingController();
  final TextEditingController anioReparacionVigasLarguerosDiafragmas =
      TextEditingController();
  final TextEditingController costoReparacionVigasLarguerosDiafragmas =
      TextEditingController();
  final TextEditingController danoReparacionVigasLarguerosDiafragmas =
      TextEditingController();
  final TextEditingController fotoReparacionVigasLarguerosDiafragmas =
      TextEditingController();

  // Elementos de Arco
  final TextEditingController calificacionElementosArco =
      TextEditingController();
  final TextEditingController mantenimientoElementosArco =
      TextEditingController();
  final TextEditingController inspeccionEspecialElementosArco =
      TextEditingController();
  final TextEditingController numeroFotosElementosArco =
      TextEditingController();
  final TextEditingController tipoDanoElementosArco = TextEditingController();

  final TextEditingController tipoReparacionElementosArco =
      TextEditingController();
  final TextEditingController cantidadReparacionElementosArco =
      TextEditingController();
  final TextEditingController anioReparacionElementosArco =
      TextEditingController();
  final TextEditingController costoReparacionElementosArco =
      TextEditingController();
  final TextEditingController danoReparacionElementosArco =
      TextEditingController();
  final TextEditingController fotoReparacionElementosArco =
      TextEditingController();

  // Cables / Pendolones / Torres / Macizos
  final TextEditingController calificacionCablesPendolonesTorresMacizos =
      TextEditingController();
  final TextEditingController mantenimientoCablesPendolonesTorresMacizos =
      TextEditingController();
  final TextEditingController inspeccionEspecialCablesPendolonesTorresMacizos =
      TextEditingController();
  final TextEditingController numeroFotosCablesPendolonesTorresMacizos =
      TextEditingController();
  final TextEditingController tipoDanoCablesPendolonesTorresMacizos =
      TextEditingController();

  final TextEditingController tipoReparacionCablesPendolonesTorresMacizos =
      TextEditingController();
  final TextEditingController cantidadReparacionCablesPendolonesTorresMacizos =
      TextEditingController();
  final TextEditingController anioReparacionCablesPendolonesTorresMacizos =
      TextEditingController();
  final TextEditingController costoReparacionCablesPendolonesTorresMacizos =
      TextEditingController();
  final TextEditingController danoReparacionCablesPendolonesTorresMacizos =
      TextEditingController();
  final TextEditingController fotoReparacionCablesPendolonesTorresMacizos =
      TextEditingController();

  // Elementos de Armadura
  final TextEditingController calificacionElementosArmadura =
      TextEditingController();
  final TextEditingController mantenimientoElementosArmadura =
      TextEditingController();
  final TextEditingController inspeccionEspecialElementosArmadura =
      TextEditingController();
  final TextEditingController numeroFotosElementosArmadura =
      TextEditingController();
  final TextEditingController tipoDanoElementosArmadura =
      TextEditingController();

  final TextEditingController tipoReparacionElementosArmadura =
      TextEditingController();
  final TextEditingController cantidadReparacionElementosArmadura =
      TextEditingController();
  final TextEditingController anioReparacionElementosArmadura =
      TextEditingController();
  final TextEditingController costoReparacionElementosArmadura =
      TextEditingController();
  final TextEditingController danoReparacionElementosArmadura =
      TextEditingController();
  final TextEditingController fotoReparacionElementosArmadura =
      TextEditingController();
  ...
  Widget build(BuildContext context) {
    List<SectionData> secciones = [
      SectionData(
        tituloSeccion: "DATOS GENERALES DE LA INSPECCIÓN",
        campos: [
          ...
          FieldData(
            labelCampo: "Fecha de inspeccion",
            controller: fechaInspeccion,
          ),
      ...
      SectionData(
        ...
        subsecciones: [
          SectionData(
            tituloSeccion: "Reparaciones",
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacion,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacion,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacion,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacion,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacion,
              ),
            ],
          ),
        ],
      ...
      SectionData(
        tituloSeccion: "JUNTAS DE EXPANSIÓN",
        campos: [
          FieldData(labelCampo: "Calificación", controller: calificacionJuntas),
          FieldData(
            labelCampo: "Mantenimiento",
            controller: mantenimientoJuntas,
          ),
          FieldData(
            labelCampo: "Inspección Especial",
            controller: inspeccionEspecialJuntas,
          ),
        ...
        subsecciones: [
          SectionData(
            ...
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacionJuntas,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacionJuntas,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacionJuntas,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacionJuntas,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacionJuntas,
              ),
            ],
          ),
        ],
      ...
      SectionData(
        tituloSeccion: "ANDENES / BORDILLOS",
        campos: [
          FieldData(
            labelCampo: "Calificación",
            controller: calificacionAndenes,
          ),
          FieldData(
            labelCampo: "Mantenimiento",
            controller: mantenimientoAndenes,
          ),
          FieldData(
            labelCampo: "Inspección Especial",
            controller: inspeccionEspecialAndenes,
          ),
        ...
        subsecciones: [
          SectionData(
            ...
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacionAndenes,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacionAndenes,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacionAndenes,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacionAndenes,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacionAndenes,
              ),
            ],
          ),
        ],
      ...
      SectionData(
        tituloSeccion: "BARANDAS",
        campos: [
          FieldData(
            labelCampo: "Calificación",
            controller: calificacionBarandas,
          ),
          FieldData(
            labelCampo: "Mantenimiento",
            controller: mantenimientoBarandas,
          ),
          FieldData(
            labelCampo: "Inspección Especial",
            controller: inspeccionEspecialBarandas,
          ),
        ...
        subsecciones: [
          SectionData(
            ...
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacionBarandas,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacionBarandas,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacionBarandas,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacionBarandas,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacionBarandas,
              ),
            ],
          ),
        ],
      ...
      SectionData(
        tituloSeccion: "CONOS / TALUDES",
        campos: [
          FieldData(labelCampo: "Calificación", controller: calificacionConos),
          FieldData(
            labelCampo: "Mantenimiento",
            controller: mantenimientoConos,
          ),
          FieldData(
            labelCampo: "Inspección Especial",
            controller: inspeccionEspecialConos,
          ),
        ...
        subsecciones: [
          SectionData(
            ...
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacionConos,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacionConos,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacionConos,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacionConos,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacionConos,
              ),
            ],
          ),
        ],
      ...
      SectionData(
        tituloSeccion: "ALETAS",
        campos: [
          FieldData(labelCampo: "Calificación", controller: calificacionAletas),
          FieldData(
            labelCampo: "Mantenimiento",
            controller: mantenimientoAletas,
          ),
          FieldData(
            labelCampo: "Inspección Especial",
            controller: inspeccionEspecialAletas,
          ),
        ...
        subsecciones: [
          SectionData(
            ...
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacionAletas,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacionAletas,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacionAletas,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacionAletas,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacionAletas,
              ),
            ],
          ),
        ],
      ...
      SectionData(
        tituloSeccion: "ESTRIBOS",
        campos: [
          FieldData(
            labelCampo: "Calificación",
            controller: calificacionEstribos,
          ),
          FieldData(
            labelCampo: "Mantenimiento",
            controller: mantenimientoEstribos,
          ),
          FieldData(
            labelCampo: "Inspección Especial",
            controller: inspeccionEspecialEstribos,
          ),
        ...
        subsecciones: [
          SectionData(
            ...
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacionEstribos,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacionEstribos,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacionEstribos,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacionEstribos,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacionEstribos,
              ),
            ],
          ),
        ],
      ...
      SectionData(
        ...
        campos: [
          ...
          FieldData(
            labelCampo: "Mantenimiento",
            controller: mantenimientoPilas,
          ),
          FieldData(
            labelCampo: "Inspección Especial",
            controller: inspeccionEspecialPilas,
          ),
        ...
        subsecciones: [
          SectionData(
            ...
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacionPilas,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacionPilas,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacionPilas,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacionPilas,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacionPilas,
              ),
            ],
          ),
        ],
      ...
      SectionData(
        ...
        campos: [
          ...
          FieldData(
            labelCampo: "Mantenimiento",
            controller: mantenimientoApoyos,
          ),
          FieldData(
            labelCampo: "Inspección Especial",
            controller: inspeccionEspecialApoyos,
          ),
        ...
        subsecciones: [
          SectionData(
            ...
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacionApoyos,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacionApoyos,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacionApoyos,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacionApoyos,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacionApoyos,
              ),
            ],
          ),
        ],
      ...
      SectionData(
        ...
        campos: [
          ...
          FieldData(
            labelCampo: "Inspección Especial",
            controller: inspeccionEspecialLosa,
          ),
        ...
        subsecciones: [
          SectionData(
            ...
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacionLosa,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacionLosa,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacionLosa,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacionLosa,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacionLosa,
              ),
            ],
          ),
        ],
      ...
      // Superficie Vigas / Largueros / Diafragmas Puente
      SectionData(
        tituloSeccion: "SUPERFICIE VIGAS / LARGUEROS / DIAFRAGMAS",
        campos: [
          FieldData(
            labelCampo: "Calificación",
            controller: calificacionVigasLarguerosDiafragmas,
          ),
          FieldData(
            labelCampo: "Mantenimiento",
            controller: mantenimientoVigasLarguerosDiafragmas,
          ),
          FieldData(
            labelCampo: "Inspección Especial",
            controller: inspeccionEspecialVigasLarguerosDiafragmas,
          ),
          FieldData(
            labelCampo: "No. Fotos",
            controller: numeroFotosVigasLarguerosDiafragmas,
          ),
          FieldData(
            labelCampo: "Tipo de daño",
            controller: tipoDanoVigasLarguerosDiafragmas,
          ),
        ],
        subsecciones: [
          SectionData(
            ...
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacionVigasLarguerosDiafragmas,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacionVigasLarguerosDiafragmas,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacionVigasLarguerosDiafragmas,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacionVigasLarguerosDiafragmas,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacionVigasLarguerosDiafragmas,
              ),
            ],
          ),
        ],
      ...
      // Elementos de Arco
      SectionData(
        tituloSeccion: "ELEMENTOS DE ARCO",
        campos: [
          FieldData(
            labelCampo: "Calificación",
            controller: calificacionElementosArco,
          ),
          FieldData(
            labelCampo: "Mantenimiento",
            controller: mantenimientoElementosArco,
          ),
          FieldData(
            labelCampo: "Inspección Especial",
            controller: inspeccionEspecialElementosArco,
          ),
          FieldData(
            labelCampo: "No. Fotos",
            controller: numeroFotosElementosArco,
          ),
          FieldData(
            labelCampo: "Tipo de daño",
            controller: tipoDanoElementosArco,
          ),
        ],
        subsecciones: [
          SectionData(
            ...
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacionElementosArco,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacionElementosArco,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacionElementosArco,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacionElementosArco,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacionElementosArco,
              ),
            ],
          ),
        ],
      ...
      // Cables / Pendolones / Torres / Macizos
      SectionData(
        tituloSeccion: "CABLES / PENDOLONES / TORRES / MACIZOS",
        campos: [
          FieldData(
            labelCampo: "Calificación",
            controller: calificacionCablesPendolonesTorresMacizos,
          ),
          FieldData(
            labelCampo: "Mantenimiento",
            controller: mantenimientoCablesPendolonesTorresMacizos,
          ),
          FieldData(
            labelCampo: "Inspección Especial",
            controller: inspeccionEspecialCablesPendolonesTorresMacizos,
          ),
          FieldData(
            labelCampo: "No. Fotos",
            controller: numeroFotosCablesPendolonesTorresMacizos,
          ),
          FieldData(
            labelCampo: "Tipo de daño",
            controller: tipoDanoCablesPendolonesTorresMacizos,
          ),
        ],
        subsecciones: [
          SectionData(
            ...
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacionCablesPendolonesTorresMacizos,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacionCablesPendolonesTorresMacizos,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacionCablesPendolonesTorresMacizos,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacionCablesPendolonesTorresMacizos,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacionCablesPendolonesTorresMacizos,
              ),
            ],
          ),
        ],
      ...
      SectionData(
        ...
        campos: [
          ...
          FieldData(
            labelCampo: "Mantenimiento",
            controller: mantenimientoCauce,
          ),
          FieldData(
            labelCampo: "Inspección Especial",
            controller: inspeccionEspecialCauce,
          ),
        ...
        subsecciones: [
          SectionData(
            ...
            campos: [
              FieldData(
                labelCampo: "Tipo de Reparación",
                controller: tipoReparacionCauce,
              ),
              FieldData(
                labelCampo: "Cantidad de Reparación",
                controller: cantidadReparacionCauce,
              ),
              FieldData(
                labelCampo: "Año de Reparación",
                controller: anioReparacionCauce,
              ),
              FieldData(
                labelCampo: "Costo de Reparación",
                controller: costoReparacionCauce,
              ),
              FieldData(
                labelCampo: "Daño Reparado",
                controller: danoReparacionCauce,
              ),
            ],
          ),
        ],
