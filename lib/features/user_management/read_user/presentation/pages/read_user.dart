            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    IconButton(
                      icon: const Icon(Icons.arrow_back, color: Color(0xff01579a)),
                      onPressed: () => Navigator.pop(context),
                    ),
                ...
                child: Column(
                  children: [
                    ElevatedButton(
                      ...
                      child: Text("Nuevo usuario", style: TextStyle(color: Color(0xffF29E23))),
                    ),
              ...
              Expanded(
                child: _isLoading
                    ...
                    : _hasError
                    ? const Center(child: Text("Error al cargar usuarios", style: TextStyle(color: Colors.red)))
                    : Padding(
